 ...
 * theme推荐接口
 **/
public class CategoryResourcesCase implements GetParamsArray, ResourceArrayCheck{
    public static Log log = LogFactory.getLog(PopupTagCase.class.getName());
    private String[] paramsArray;
    public int line;//参数在csv文件行数在csvList中的index
    private final String apiName = "category resources List接口";
    ...
    public void TestCase() throws IOException {
        ...
        Check(line,responseStr,ResourceArrayCheckImpl.getInstance().resource_list);
    }
