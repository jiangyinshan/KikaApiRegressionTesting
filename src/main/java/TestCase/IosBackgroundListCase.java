 ...
 * theme推荐接口
 **/
public class IosBackgroundListCase implements GetParamsArray, ResourceArrayCheck{
    public static Log log = LogFactory.getLog(PopupTagCase.class.getName());
    private String[] paramsArray;
    public int line;//参数在csv文件行数在csvList中的index
    private final String apiName = "ios diy背景列表接口";
    ...
    public void TestCase() throws IOException {
        ...
        Check(line,responseStr,ResourceArrayCheckImpl.getInstance().backgroundLlist);
    }
