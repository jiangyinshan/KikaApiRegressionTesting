...
public class GetTitleCase implements GetParamsArray, ResourceArrayCheck {
    ...
    public void TestCase() throws IOException {
        ...
        Check(line,responseStr,ResourceArrayCheckImpl.getInstance().title_list);
    }
