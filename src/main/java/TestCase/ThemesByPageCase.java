 ...
 * theme推荐接口
 **/
public class ThemesByPageCase implements GetParamsArray, ResourceArrayCheck, ParamExistCheck {
    public static Log log = LogFactory.getLog(PopupTagCase.class.getName());
    private String[] paramsArray;
    public int line;//参数在csv文件行数在csvList中的index
    private final String apiName = "分页获取themes接口";
    private final String[] responseParamArray = {"pageSize", "pageNum", "theme_list"};
