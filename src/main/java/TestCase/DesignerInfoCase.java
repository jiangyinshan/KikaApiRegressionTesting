...
public class DesignerInfoCase implements GetParamsArray, ParamExistCheck{
    public static Log log = LogFactory.getLog(PopupTagCase.class.getName());
    private String[] paramsArray;
    public int line;//参数在csv文件行数在csvList中的index
    private final String apiName = "设计师信息接口";
    private final String[] responseParamArray = {"caver","icon","link","name","description","id","key"};
