 ...
 * theme推荐接口
 **/
public class GetSimpleAppConfigCase implements GetParamsArray, ParamExistCheck {
    public static Log log = LogFactory.getLog(PopupTagCase.class.getName());
    private String[] paramsArray;
    public int line;//参数在csv文件行数在csvList中的index
    private final String apiName = "get_simple_app_config接口";
    private final String[] responseParamArray = {"push_msg_config"};
